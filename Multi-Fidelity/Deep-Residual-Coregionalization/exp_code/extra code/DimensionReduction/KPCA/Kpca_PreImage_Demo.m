...
%% Main
[Z1,model] = Kpca(X,options);
X_star = Kpca_PreImage(Z1,model,preoptions);

options.new_dim=0.999;
[Z2,model2] = kpcaInit(X,options);
X_star2 = Kpca_PreImage(Z2,model2,preoptions);
