...
if ~isfield(options,'neighborPara'), options.neighborPara = round(num/5); end % 10% of point as neighbor point;
...
if options.neighborPara < 3, options.neighborPara = 3;end
...
[Z,model_mds] = mdsInit(D_F_mirror,options.dim_new);
Z = real(Z);
