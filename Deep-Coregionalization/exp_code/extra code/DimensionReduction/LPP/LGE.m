...
%     [junk, index] = sort(diag(eigvalue), 'descend');    % Modified by
%     WeiX 9-11-2015. Test. The command is equivalent to that used in the
%     original code. Which means uisng largetest eigenvalues rather than
%     smallest.
