function [Ypred, model] = mlvIsomapGp(xtr,Ytr,xte,r)

    options.dim_new=r;                % New dimension
    options.neighborType='k';               % Type of neighbor.Choice:1)'k';Choice:2)'epsilon'
    options.neighborPara=100;                % parameter for choosing the neighbor. number of neighbor for "k" type and radius for 'epsilon'
